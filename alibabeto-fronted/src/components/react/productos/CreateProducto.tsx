...
const CreateProducto = () => {
    ...
    return (
        <>
            ...
            <div className="p-7 rounded-lg mx-auto bg-white border">
                <form onSubmit={handleSubmitForm}>
                    ...
                    <button
                        type="submit"
                        className="text-white w-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg font-bold px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                        Crear
                    </button>
                </form>
