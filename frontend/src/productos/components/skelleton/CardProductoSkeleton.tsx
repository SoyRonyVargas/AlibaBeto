...
const CardProductoSkeleton = () => {
    return (
        <div className="w-full h-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div className='p-3'>
                <div className="w-full h-52 bg-gray-300 rounded-lg dark:bg-gray-600"></div>
            </div>
            <div className="px-5 pb-5">
                <a>
                    <p className='opacity-50 text-xs'>
                        <h1 className="w-full h-2 mt-2 bg-gray-200 rounded-lg dark:bg-gray-700"></h1>
                    </p>
                ...
                <div className="flex items-center mt-2.5 ">
                    ...
                    <span className="bg-gray-100 text-gray-300 text-xs font-semibold px-2.5 py-0.5 rounded ms-3">5.0</span>
                </div>
                {/* <div className="flex items-start justify-between flex-col">
                    <h1 className="w-full h-2 mt-4 bg-gray-200 rounded-lg dark:bg-gray-700"></h1>
                    <a
                        className={`blockw-full mt-3 font-medium rounded-md text-xs px-5 py-2.5 text-center`}
                    >
                        Comprar
                    </a>
                </div> */}
